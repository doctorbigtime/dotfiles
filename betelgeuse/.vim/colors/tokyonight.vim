...
if s:configuration.style ==# 'night'
  let s:palette = {
        ...
        \ 'purple':     ['#9d7cd8',   '176',  'Magenta'],
        \ 'grey':       ['#444A73',   '246',  'LightGrey'],
        \ 'none':       ['NONE',      'NONE', 'NONE']
        \ }
...
call s:HL('Operator', s:palette.cyan0, s:palette.none)
